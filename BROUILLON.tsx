...
const UserInformation = ({
  ...
  return (
    <div className="bg-white w-[600px] pb-[30px] rounded-lg z-10">
      <h1 className="text-black text-2xl font-bold mx-auto mt-8 text-center">
        USER INFORMATION
      </h1>
      <div className="flex mt-8 mx-auto w-3/4">
        ...
        <div className="w-3/4 bg-gray-100 p-4 rounded-lg">
          ...
          <div className="flex justify-between">
            ...
            <ToggleSwitch
              isOn={user.twoFactorEnabled}
              handleToggle={handle2FAToggle}
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-4">
        {!isEditMode ? (
          <EditButton text="Update Profile" onClick={handleUpdateClick} />
        ) : null}
        {isEditMode ? (
